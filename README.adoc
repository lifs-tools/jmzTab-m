...
image:https://travis-ci.org/nilshoffmann/jmzTab-m.svg?branch=master["Build Status", link="https://travis-ci.org/nilshoffmann/jmzTab-m"] image:https://img.shields.io/maven-central/v/de.isas.mztab/jmztabm-cli.svg["Maven Central", link="https://search.maven.org/remotecontent?filepath=de/isas/mztab/jmztabm-cli/1.0.0/jmztabm-cli-1.0.0-bin.zip"]
...
where `jmztab.version` is the version of jmztabm you wish to use, e.g. for a release version:
  ...
  <properties>
    <jmztabm.version>1.0.0</jmztabm.version>
  </properties>
