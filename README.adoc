...
* https://github.com/lifs-tools/jmzTab-m/blob/master/io/src/test/java/de/isas/mztab2/io/serialization/SmallMoleculeEvidenceSectionSerializerTest.java[SmallMoleculeEvidenceSectionSerializerTest] - shows how to add optional columns to the SmallMoleculeEvidenceSection _with_ the OptColumnMappingBuilder.
