 ...
 * integer) to record the column location in mzTab file. And use {@link uk.ac.ebi.pride.jmztab2.utils.parser.PositionMapping} structure to maintain
...
public abstract class MZTabDataLineParser<T> extends MZTabLineParser {
    ...
    /**
     * Check and translate target string into Integer. If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
     *
     * @param column SHOULD NOT set null
     * @param target SHOULD NOT be empty.
     * @return a {@link java.lang.Integer} object.
    ...
    /**
     * Check and translate target string into Double. If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Double} error.
     *
     ...
     * If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#ParamList} error.
     *
     * @param column SHOULD NOT set null
     * @param target SHOULD NOT be empty.
     ...
     * <p>checkParameter.</p>
     *
     * @param column a {@link uk.ac.ebi.pride.jmztab2.model.IMZTabColumn} object.
    ...
    /**
     * Check and translate target to {@link uk.ac.ebi.pride.jmztab2.model.MZBoolean}. Only "0" and "1" allow used in express Boolean (0/1).
     * If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#MZBoolean} error.
     *
     * @param column SHOULD NOT set null
     * @param target SHOULD NOT be empty.
    ...
    /**
     * Check and translate taxid string into Integer. If exists error during parse, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
    ...
    /**
     * Check and translate numPSMs string into Integer. If exists error during parse, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
    ...
    /**
     * Check and translate numPeptidesDistinct string into Integer. If exists error during parse, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
    ...
    /**
     * Check and translate numPeptidesUnique string into Integer. If exists error during parse, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
    ...
    /**
     * Check and translate spectraRef string into {@link de.isas.mztab2.model.SpectraRef} list.
     * If parse incorrect, or ms_run not defined in metadata raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#SpectraRef} error.
     ...
     * If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#StringList} error. Besides, each item in list should be
     * start with "GO:", otherwise system raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#GOTermList} error.
    ...
    /**
     * Check and translate protein_coverage string into Double. If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Double} error.
     * protein_coverage range should be in the [0, 1), otherwise raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.LogicalErrorType#ProteinCoverage} error.
     *
     * NOTICE: If ratios are included and the denominator is zero, the "INF" value MUST be used. If the result leads
     * to calculation errors (for example 0/0), this MUST be reported as "not a number" ("NaN").
     *
     ...
     * which can not displayed in the sequence. So, if find it, system raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Sequence} error.
     *
     * @param column SHOULD NOT set null
    ...
    /**
     * Check and translate psm_id string into Integer. If exists error during parse, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
    ...
    /**
     * Check and translate unique to {@link uk.ac.ebi.pride.jmztab2.model.MZBoolean}. Only "0" and "1" allow used in express Boolean (0/1).
     * If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#MZBoolean} error.
     *
     * @param column SHOULD NOT set null
    ...
    /**
     * Check and translate charge string into Integer. If exists error during parse, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Integer} error.
    ...
    /**
     * Check and translate mass_to_charge string into Double. If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Double} error.
     *
     * NOTICE: If ratios are included and the denominator is zero, the "INF" value MUST be used. If the result leads
     * to calculation errors (for example 0/0), this MUST be reported as "not a number" ("NaN").
     *
    ...
    /**
     * Check and translate exp_mass_to_charge string into Double. If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Double} error.
     *
     * NOTICE: If ratios are included and the denominator is zero, the "INF" value MUST be used. If the result leads
     * to calculation errors (for example 0/0), this MUST be reported as "not a number" ("NaN").
     *
    ...
    /**
     * Check and translate calc_mass_to_charge string into Double. If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#Double} error.
     *
     * NOTICE: If ratios are included and the denominator is zero, the "INF" value MUST be used. If the result leads
     * to calculation errors (for example 0/0), this MUST be reported as "not a number" ("NaN").
     *
     ...
     * If parse incorrect, raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.FormatErrorType#DoubleList} error.
