...
import static uk.ac.ebi.pride.jmztab1_1.model.MZTabConstants.CALCULATE_ERROR;
import static uk.ac.ebi.pride.jmztab1_1.model.MZTabConstants.INFINITY;
...
import static uk.ac.ebi.pride.jmztab1_1.model.MZTabUtils.parseDouble;
...
public abstract class MZTabRecord {
    ...
    private boolean isMatch(String logicalPosition, Class valueType) {
        IMZTabColumn column = factory.getColumnMapping().get(logicalPosition);
        if (column == null) {
            return false;
        }
...
//    }
     ...
     */
    private IMZTabColumn getAbundanceColumn(String tag, IndexedElement element) {
        if (element == null) {
