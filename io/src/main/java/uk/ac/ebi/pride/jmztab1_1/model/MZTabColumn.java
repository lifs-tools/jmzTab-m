...
/**
 * Define a column header which used in {@link uk.ac.ebi.pride.jmztab1_1.model.Section#Protein_Header}, {@link uk.ac.ebi.pride.jmztab1_1.model.Section#Peptide_Header},
 * {@link uk.ac.ebi.pride.jmztab1_1.model.Section#PSM_Header}, or {@link uk.ac.ebi.pride.jmztab1_1.model.Section#Small_Molecule_Header}. There are two kinds of columns: stable column
 * and optional column. Stable column has stable position and header name, while optional column not.
 * {@link uk.ac.ebi.pride.jmztab1_1.model.MZTabColumnFactory} used to create and maintain these column objects.
 *
...
public class MZTabColumn implements IMZTabColumn {
     ...
     * @param dataType define the data type for column. When {@link uk.ac.ebi.pride.jmztab1_1.model.MZTabRecord#setValue(String, Object)} for this column,
     ...
     * @param order internal order. Every non {@link uk.ac.ebi.pride.jmztab1_1.model.OptionColumn} has stable order. Column order is used to maintain the
     *              logical position in {@link uk.ac.ebi.pride.jmztab1_1.model.MZTabColumnFactory}
     */
     ...
     *
     *<p>Notice: in {@link MZTabColumnFactory}, we use logical position to maintain the logical consistence within the {@link de.isas.mztab1_1.model.MzTab} file.
