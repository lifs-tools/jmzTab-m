            ...
            if (msRunRef != null) {
                addSubElementStrings(jg, Section.Metadata.getPrefix(), assay,
                    Assay.Properties.msRunRef.getPropertyName(), msRunRef.
                        ...
                        map((mref) ->
                        {
                            return new StringBuilder().append(de.isas.mztab2.model.Metadata.Properties.msRun.getPropertyName()).
                                append("[").
                                append(mref.getId()).
                                append("]").
                                toString();
            ...
            if (sampleRef != null) {
                addSubElementStrings(jg, Section.Metadata.getPrefix(), assay,
                    Assay.Properties.sampleRef.getPropertyName(), Arrays.asList(sampleRef).
                        ...
                        map((sref) ->
                        {
                            return new StringBuilder().append(de.isas.mztab2.model.Metadata.Properties.sample.getPropertyName()).
                                append("[").
                                append(sref.getId()).
                                append("]").
                                toString();
