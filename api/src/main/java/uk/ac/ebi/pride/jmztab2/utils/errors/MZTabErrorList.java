...
/**
 * A limit max capacity list, if contains a couple of {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabError} objects.
 * If overflow, system will raise {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorOverflowException}. Besides this, during
 * add a new {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabError} object, it's {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorType#level} SHOULD equal or
...
public class MZTabErrorList {
    ...
    /**
     * Generate a error list, which max size is {@link uk.ac.ebi.pride.jmztab2.utils.MZTabProperties#MAX_ERROR_COUNT},
     * and only allow {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorType.Level#Error} or greater level errors to be added
     * into list.
     */
     ...
     * Generate a error list, which max size is {@link uk.ac.ebi.pride.jmztab2.utils.MZTabProperties#MAX_ERROR_COUNT}
     *
     * @param level if null, default level is {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorType.Level#Error}
     */
     ...
     *        {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorOverflowException} is thrown
     */
     ...
     * @return a boolean.
     * @throws uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorOverflowException if any.
     */
     ...
     *
     * @return The maximum number of errors that are going to be reported before the parser stops with an {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorOverflowException}
     */
    ...
    /**
     * Define the maximum number of errors recorded by this list before an {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorOverflowException} is thrown
     *
     ...
     *
     * @return level of errors reported {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorType#level}
     */
     ...
     *
     * @param level {@link uk.ac.ebi.pride.jmztab2.utils.errors.MZTabErrorType#level}
     */
